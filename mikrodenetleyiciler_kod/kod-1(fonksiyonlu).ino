...
{  
  ...
  if(buton_degeri1 == 1){
   ...
   if (hafiza ==1){
     ...
     else if ((millis()-eski_zaman2 >=0) && (millis()-eski_zaman2 <=hesap2)){
        cikis_2();}
     
     else if ((millis()-eski_zaman3 >=0) && (millis()-eski_zaman3 <hesap3)){
       cikis_3();}
     
     else if ((millis()-eski_zaman4 >=0) && (millis()-eski_zaman4 <hesap4)){
       	cikis_4();} 
